...
module.exports = {
  entry: {
    ...
    '03_about_truthyness.spec.js': './test/03_about_truthyness.spec.js',
    '04_about_assignment': './test/04_about_assignment.spec.js',
    '05_about_control_structures.spec.js': './test/05_about_control_structures.spec.js',
    '06_about_strings': './test/06_about_strings.spec.js',
    '07_about_numbers.spec.js': './test/07_about_numbers.spec.js',
    '08_about_objects': './test/08_about_objects.spec.js',
    '09_about_arrays.spec.js': './test/09_about_arrays.spec.js',
    '10_about_reflection': './test/10_about_reflection.spec.js',
    '11_about_prototype_chain.spec.js': './test/11_about_prototype_chain.spec.js',
    '12_about_prototypal_inheritance': './test/12_about_prototypal_inheritance.spec.js',
    '13_about_functions_and_closure.spec.js': './test/13_about_functions_and_closure.spec.js',
    '14_about_this': './test/14_about_this.spec.js',
    '15_about_scope.spec.js': './test/15_about_scope.spec.js',
